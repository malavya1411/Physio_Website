...
const StarIcon = () => (
  <svg className="w-4 h-4 text-[#0A192F]" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
  ...
  return (
    <div className="bg-white rounded-2xl card-shadow p-6 flex flex-col gap-4 transition-subtle hover:shadow-md hover:-translate-y-0.5">
      ...
      <div className="flex items-center gap-3 mt-2">
        {/* Avatar */}
        <div
          className="w-10 h-10 rounded-full bg-[#0A192F] flex items-center justify-center text-white font-poppins font-semibold text-base flex-shrink-0"
          aria-hidden="true"
