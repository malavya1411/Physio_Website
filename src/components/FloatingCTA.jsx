  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed bottom-0 left-0 right-0 z-50 flex md:hidden border-t border-[#1F2937]/10 bg-white"
        style={{ height: '56px' }}
      >
        <a
          href={telLink()}
          aria-label="Call the clinic"
          className="flex-1 flex items-center justify-center gap-2 bg-[#0F766E] text-white font-inter font-medium text-sm transition-subtle hover:bg-[#0d6560]"
        ...
        <a
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-white text-[#0F766E] font-inter font-medium text-sm transition-subtle hover:bg-[#0F766E]/5"
          style={{ fontFamily: 'Inter, sans-serif' }}
        >
          <WhatsAppIconTeal />
          WhatsApp
